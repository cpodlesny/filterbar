import <%= upCaseName %>Module from './<%= pathName %>'
import <%= upCaseName %>Controller from './<%= pathName %>.controller';
import <%= upCaseName %>Component from './<%= pathName %>.component';
import <%= upCaseName %>Template from './<%= pathName %>.html';
